...
#ifndef MACJackUserClient_H
#define MACJackUserClient_H
...
#include "MACJackDriverInterface.h"

class MACJackUserClient : public IOUserClient {
    OSDeclareDefaultStructors(MACJackUserClient);
