...
#ifndef MACJACKDRIVER_H
#define MACJACKDRIVER_H
...
class MACJackDriver : public IOService {
    OSDeclareDefaultStructors(MACJackDriver);
...
public:
    ...
    MACJackCard* getWLCard() { return _wlCard; }
